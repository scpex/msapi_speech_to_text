...
var azureClientSecret = 'c8c1c9cab2c14e428948be656fbf3cba';
var speechTranslateUrl = 'wss://dev.microsofttranslator.com/speech/translate?api-version=1.0&from=ko&to=th';

// input wav file is in PCM 16bit, 16kHz, mono with proper WAV header
//var file = '99Problems.wav';
//var file = 'Hugo2.wav';
var file = 'Hugo3.wav';
...
request.get({
    ...
    headers: {
        'Accept-Language': 'en-th' // the language names will be localized to the 'Accept-Language'
    }
},
